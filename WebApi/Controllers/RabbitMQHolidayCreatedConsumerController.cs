...
{
    public class RabbitMQHolidayCreatedConsumerController : IRabbitMQConsumerController
    {
        ...
        public RabbitMQHolidayCreatedConsumerController(IServiceScopeFactory scopeFactory, IConnectionFactory factory)
        {
